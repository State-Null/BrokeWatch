...
* ⏱️ **Rolling Loss Window**: Displays your rolling expenditure over the last 15 minutes (or any custom duration defined in `user_settings.recent_interval`). Updates dynamically during combat.
